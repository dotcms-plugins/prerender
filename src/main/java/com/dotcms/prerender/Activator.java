...
public final class Activator extends GenericBundleActivator {
    ...
    private final PreRenderSEOWebInterceptor appWebInterceptor = new PreRenderSEOWebInterceptor();
    ...
    public void start(BundleContext context) throws Exception {
        ...
        Logger.info(this.getClass().getName(), "Activating PreRenderSEOWeb App");
